...
public class GelecekRandevularListAdapter extends ArrayAdapter<RandevuPOJO> {

    private List<RandevuPOJO> randevular;
    private ArrayList<RandevuPOJO> arrayList;
    private DBHelper dbHelper;

    public GelecekRandevularListAdapter(Context context, List<RandevuPOJO> listeRandevular) {
